    ...
    function DatabaseService($q, $window) {
        ...
        service.open = function () {
            ...
            request.onupgradeneeded = function (e) {
                ...
                active.createObjectStore("characters", {keyPath: 'id', autoIncrement: true});
                active.createObjectStore("weapons", {keyPath: 'id', autoIncrement: true});
                active.createObjectStore("items", {keyPath: 'id', autoIncrement: true});
